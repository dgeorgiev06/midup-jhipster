...
import { getSearchEntities, getEntities, reset } from './user-profile.reducer';
...
export interface IUserProfileState extends IPaginationBaseState {
  search: string;
}
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('addressLongitude')}>
                    Address Longitude <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('addressLatitude')}>
                    Address Latitude <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {userProfileList.map((userProfile, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{userProfile.addressLongitude}</td>
                    <td>{userProfile.addressLatitude}</td>
